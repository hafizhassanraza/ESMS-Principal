...
public class Adapter_TotalPendingFee extends RecyclerView.Adapter<Adapter_TotalPendingFee.ImageViewHolder> {
    Context context;
    List<Fee> list;

    public Adapter_TotalPendingFee(Context context, List<Fee> list) {
        this.list = list;
    ...
    public ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.pendingfeename, parent, false);
    ...
    public void onBindViewHolder(@NonNull ImageViewHolder holder, int position) {
        ...
        holder.amount.setText(presentStudent.getPayableAmount());
